...
function nextReason() {
  ...
  // Remove animation class and restart it
  ...
  // Change background image of why choose us section dynamically
  whySection.style.backgroundImage = `url('${reasons[currentReason].bg}')`;
}

// Initialize background for reasons section on page load
window.onload = () => {
  const whySection = document.getElementById("why-choose-us");
